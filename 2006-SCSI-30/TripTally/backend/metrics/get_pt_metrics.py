...
def get_all_pt_metrics(distance_km, transport_type="mrt", bus_number=None, fare_category="adult_card_fare"):
    ...
    try:
        ...
        import logging
        logging.error(f"Error in get_all_pt_metrics: {str(e)}")
        raise

'''--------- Example Usage --------'''
#print(retrieve_api_data())
#print(retrieve_express_bus_fares())
#print(retrieve_feeder_bus_fares()) 
#print(retrieve_trunk_bus_fares())
#print(retrieve_mrt_lrt_fares())
#print(calculate_bus_fare("feeder", 15, "adult_card_fare"))
#print(get_bus_type_from_bus_num("812"))
#print(calculate_mrt_lrt_fare(27.5, "adult_card_fare"))